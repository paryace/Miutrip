...
@property (strong, nonatomic) NSMutableArray      *costs;

- (void)getObjects;

@end

@interface  CostCenterList : BaseResponseModel
...
@property (strong, nonatomic) NSMutableArray       *SelectItem;            //cost center list
