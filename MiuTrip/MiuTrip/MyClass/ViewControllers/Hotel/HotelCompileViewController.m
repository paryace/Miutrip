...
@implementation HotelCompileViewController

static HotelCompileViewController *sharedHotelCompile;

+ (HotelCompileViewController*)sharedHotelCompile{
    sharedHotelCompile = [[HotelCompileViewController alloc]init];
    return sharedHotelCompile;
}
...
{
    _costCenter = [params objectAtIndex:indexPath.row];
    [_costCenterNameLabel setText:_costCenter];
}
...
- (void)setSubviewFrame
{
    ...
    [saveBtn addTarget:self action:@selector(compilePassenger) forControlEvents:UIControlEventTouchUpInside];
...
-(void)setSubjoinViewFrame{
    ...
    [_nameTextField setText:_userName];
...
{
    CostCenterController *costView = [[CostCenterController alloc] init];
...
@interface CostCenterController ()
...
@implementation CostCenterController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CostDetailCell *cell = nil;
    cell = [tableView dequeueReusableCellWithIdentifier:selectOtherIdentifierStr];
    if (cell == nil) {
        cell = [[CostDetailCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:selectOtherIdentifierStr];
    }
